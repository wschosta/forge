"""Stop word list — replaces +la/getCommonWordsList.m.

Contains 700+ common English words, US state names/abbreviations,
months, Roman numerals, single letters, and legislative terms that
should be excluded from bill text classification.
"""
...
def get_common_words() -> list[str]:
    """Return the full stop word list used in bill text classification.

    This is a direct port of la.getCommonWordsList() from MATLAB.
    Words are stored in their original mixed-case form; comparison should
    be done case-insensitively (the cleanup function upper-cases everything).
    """
    # Common English words (from MATLAB)
    common = [
        ...
        "plant", "cover", "sun", "four", "between", "state", "keep", "eye", "never", "last", "let",
        "thought", "city", "tree", "cross", "farm", "hard", "start", "might", "story", "saw", "far",
        "sea", "draw", "left", "late", "run", "dont", "while", "press", "close", "night", "real",
        ...
        "count", "square", "reason", "length", "represent", "art", "subject", "region", "hunt",
        ...
        "hill", "safe", "cat", "century", "consider", "type", "bit", "coast", "copy", "phrase",
        ...
        "whose", "locate", "ring", "character", "insect", "caught", "period", "indicate", "radio",
        "spoke", "atom", "human", "history", "effect", "electric", "expect", "crop", "modern",
        "element", "hit", "student", "corner", "party", "supply", "bone", "rail", "imagine",
        "provide", "agree", "thus", "capital", "wont", "chair", "danger", "fruit", "rich", "thick",
        "soldier", "process", "operate", "guess", "necessary", "sharp", "wing", "create",
        ...
        "company", "subtract", "event", "particular", "deal", "swim", "term", "opposite", "wife",
        "shoe", "shoulder", "spread", "arrange", "camp", "invent", "cotton", "born", "determine",
        "quart", "nine", "truck", "noise", "level", "chance", "gather", "shop", "stretch", "throw",
        "shine", "property", "column", "molecule", "select", "wrong", "gray", "repeat", "require",
    ...
    # US state names, abbreviations, territories
    states = [
        ...
        "IL", "IN", "KS", "KY", "LA", "MA", "MD", "ME", "MH", "MI", "MN", "MO", "MS", "MT", "NC",
        "ND", "NE", "NH", "NJ", "NM", "NV", "NY", "OH", "OK", "OR", "PA", "PR", "PW", "RI", "SC",
        "SD", "TN", "TX", "UT", "VA", "VI", "VT", "WA", "WI", "WV", "WY",
    ]

    # Additional terms: Roman numerals, months, legislative terms, etc.
    extra = [
        "jr", "january", "february", "march", "april", "may", "june", "july", "august",
        "september", "october", "november", "december", "secretary", "anniversary", "federal",
        "programs", "program", "united", "act", "states", "national", "america", "american", "not",
        "bi", "br", "DS", "LI", "UL", "non", "met", "WT",
    ...
    # Legislative-specific terms
    legislative = ["bill", "ammendment", "amends", "sec", "Requires", "directs", "prohibits",
                   "requirements", "relating"]

    return common + states + extra + legislative
