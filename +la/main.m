...
if process_algorithm
    ...
    x(1) = awv;
    x(2) = iwv;
    outputs = la.processAlgorithm(x,threshold,learning_materials,learning_table,data_storage,0);
...
for j = 1:robust
    for k = 1:max_grid_size
        for l = 1:max_grid_size
            ...
            for i = 1:iterations
                f = @(x)la.processAlgorithm(x,threshold,learning_materials,learning_table,data_storage,1);
